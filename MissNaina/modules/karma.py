import asyncio
from MissNaina.utils.permissions import adminsOnly
from MissNaina import pgram as app, OWNER_ID, db
from MissNaina.utils.errors import capture_err
from MissNaina.modules.mongo.karma_mongo import (
    alpha_to_int,
    get_karma,
    get_karmas,
    int_to_alpha,
