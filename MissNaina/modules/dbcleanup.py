import MissNaina.modules.sql.global_bans_sql as gban_sql
import MissNaina.modules.sql.users_sql as user_sql

from time import sleep
from MissNaina import DEV_USERS, OWNER_ID, dispatcher
